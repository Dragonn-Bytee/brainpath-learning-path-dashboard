...
export default function LoginPage() {
    ...
    console.log('Resolved googleClientId:', googleClientId);
    console.log('isDummyClientId:', isDummyClientId);
    ...
    return (
        <div style={{ 
            ...
            >
                ...
                >
                    <img src="/brainpath-logo.png" alt="BrainPath" style={{ width: '48px', height: '48px', objectFit: 'contain' }} />
                    <h2 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-1px', color: '#000000' }}>BrainPath</h2>
                </motion.div>
                ...
                <motion.h3 
                    ...
                    style={{ fontSize: '1.25rem', fontWeight: 600, textAlign: 'center', marginBottom: '2rem', color: '#000000' }}
                >
                    Welcome back!
                </motion.h3>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    >
                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '0.6rem', fontSize: '0.8rem', fontWeight: 600, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '1px' }}>
                ...
                <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.9rem', color: '#6b7280' }}>
                    Don't have an account? <Link to="/register" style={{ color: '#000000', fontWeight: 700, textDecoration: 'none', marginLeft: '8px' }}>Sign up</Link>
                </p>
            </motion.div>
